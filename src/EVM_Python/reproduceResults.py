...
# Date: June 2012
    ...
    clear
    dataDir='./data'
# reproduceResults.m:14
    resultsDir='ResultsSIGGRAPH2012'
# reproduceResults.m:15
    mkdir(resultsDir)
    ## baby
    inFile=fullfile(dataDir,'baby.mp4')
# reproduceResults.m:21
